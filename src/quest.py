...
# Done
b = Fore.YELLOW + "How much time does it take for a day in Venus to finish ?"
# Done
...
# Done 
k = Fore.YELLOW + "What do you call something that is  swirling in Black Hole ? "
# Done
...
ac = Fore.YELLOW + "How small is Pluto"
ad =  Fore.YELLOW + "Can there be a white hole ?"
af =  Fore.YELLOW + "How many Earth days does it take for a day in Venus to pass ?"
