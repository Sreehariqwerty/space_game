...
import tkinter
from tkinter import PhotoImage, Button, Label, FLAT
            ...
            def NextofAppolo():
                ...
                def NorthStar():
                    ...
                    def QuizDecision():
                        ...
                        About = Label(
                            root,
                            text = "This project was developed by Ahil and Sreehari, \n Who are students of SSRVM Banglore East. \n To check out more amazing projects \n Visit https://github.com/pynvimdev",
                            font = ("Jetbrains Mono NF ",17),
                            bg = "#ffffff"
                        )
                ...
                NextForTheQuiz.pack(pady=(30,40))
